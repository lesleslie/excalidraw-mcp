...
class TestElementPerformance:
    ...
    def test_memory_usage_element_creation(self, performance_monitor):
        ...
        for i in range(element_count):
            ...
            if i % 1000 == 0 and i > 0:
                ...
                assert memory_per_element < 1024, f"Memory per element too high: {memory_per_element:.2f} bytes"
    ...
    @pytest.mark.performance
    def test_validation_error_performance(self, performance_monitor, security_test_data):
        ...
        invalid_cases = [
            ...
            {"type": "rectangle", "x": 100, "y": 200, "strokeWidth": 100},  # Out of range
    ...
    @pytest.mark.performance
    def test_large_text_element_performance(self, performance_monitor, security_test_data):
    ...
    def test_element_update_preparation_performance(self, performance_monitor):
        ...
        update_scenarios = [
            ...
            {"id": "test-abc", "text": "Updated text", "fontSize": 20, "fontFamily": "Arial"},
    ...
    def test_thread_safety_performance(self, performance_monitor):
        ...
        with ThreadPoolExecutor(max_workers=thread_count) as executor:
            ...
            for thread_id in range(thread_count):
                future = executor.submit(create_elements_in_thread, thread_id, elements_per_thread)
