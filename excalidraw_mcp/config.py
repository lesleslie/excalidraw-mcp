...
class Config:
    ...
    def _load_from_environment(self):
        ...
        # Server config
        self.server.express_url = os.getenv("EXPRESS_SERVER_URL", self.server.express_url)
        self.server.canvas_auto_start = os.getenv("CANVAS_AUTO_START", "true").lower() != "false"
