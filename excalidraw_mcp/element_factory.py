...
class ElementFactory:
    ...
    def prepare_update_data(self, update_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for key, value in update_data.items():
            if key not in ["createdAt", "version"]:  # Protect immutable fields
                if key in ["x", "y", "width", "height", "strokeWidth", "opacity", "roughness", "fontSize"]:
    ...
    def _add_optional_properties(self, element: Dict[str, Any], element_data: Dict[str, Any]) -> None:
    ...
    def _add_visual_properties(self, element: Dict[str, Any], element_data: Dict[str, Any]) -> None:
        ...
        element["strokeWidth"] = self._get_optional_float(element_data, "strokeWidth", 2)
    ...
    def _add_shape_properties(self, element: Dict[str, Any], element_data: Dict[str, Any]) -> None:
    ...
    def _add_line_properties(self, element: Dict[str, Any], element_data: Dict[str, Any]) -> None:
    ...
    def _get_optional_float(self, data: Dict[str, Any], key: str, default: Optional[float] = None) -> Optional[float]:
    ...
    def validate_element_data(self, element_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if element_data.get("type") not in valid_types:
            errors.append(f"Invalid element type. Must be one of: {', '.join(valid_types)}")
    ...
    def _validate_numeric_ranges(self, element_data: Dict[str, Any], errors: list) -> None:
