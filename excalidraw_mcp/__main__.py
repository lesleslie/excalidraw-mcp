...
class ExcalidrawMCPServer(BaseOneiricServerMixin):
    ...
    def _update_global_config(self) -> None:
        ...
        global_config.server.express_host = self.config.http_host  # ty: ignore[unresolved-attribute]
        global_config.server.express_port = self.config.http_port  # ty: ignore[unresolved-attribute]
    ...
    async def startup(self) -> None:
        ...
        print(f"   Listening on {self.config.http_host}:{self.config.http_port}")  # ty: ignore[unresolved-attribute]
