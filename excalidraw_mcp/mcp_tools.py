...
class MCPToolsManager:
    ...
    async def _sync_to_canvas(self, operation: str, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if operation == "create":
                ...
                return {"success": await http_client.delete(f"/api/elements/{data['id']}")}
    ...
    async def create_element(self, request: BaseModel) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Element creation failed: {str(e)}"
            }
    ...
    async def update_element(self, request: BaseModel) -> Dict[str, Any]:
        ...
        try:
            ...
            if not element_id:
                return {
                    "success": False,
                    "error": "Element ID is required for updates"
                }
            ...
            if result and result.get("success"):
                ...
                return {
                    "success": False,
                    "error": "Failed to update element on canvas"
                }
            ...
            return {
                "success": False,
                "error": f"Element update failed: {str(e)}"
            }
    ...
    async def delete_element(self, element_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Element deletion failed: {str(e)}"
            }
    ...
    async def query_elements(self, request: BaseModel) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Element query failed: {str(e)}"
            }
    ...
    async def group_elements(self, element_ids: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result and result.get("success"):
                ...
                return {
                    "success": False,
                    "error": "Failed to group elements on canvas"
                }
            ...
            return {
                "success": False,
                "error": f"Element grouping failed: {str(e)}"
            }
    ...
    async def ungroup_elements(self, group_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Element ungrouping failed: {str(e)}"
            }
    ...
    async def align_elements(self, request: BaseModel) -> Dict[str, Any]:
        ...
        try:
            ...
            if result and result.get("success"):
                ...
                return {
                    "success": False,
                    "error": "Failed to align elements on canvas"
                }
            ...
            return {
                "success": False,
                "error": f"Element alignment failed: {str(e)}"
            }
    ...
    async def distribute_elements(self, request: BaseModel) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await http_client.post_json("/api/elements/distribute", distribute_data)
            ...
            return {
                "success": False,
                "error": f"Element distribution failed: {str(e)}"
            }
    ...
    async def lock_elements(self, element_ids: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result and result.get("success"):
                ...
                return {
                    "success": False,
                    "error": "Failed to lock elements on canvas"
                }
            ...
            return {
                "success": False,
                "error": f"Element locking failed: {str(e)}"
            }
    ...
    async def unlock_elements(self, element_ids: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Element unlocking failed: {str(e)}"
            }
